  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 md:p-6 relative overflow-hidden bg-[#e8eaf0]">
      ...
      <div className="relative w-full max-w-4xl h-[650px] md:h-[600px] bg-white/40 backdrop-blur-2xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.08)] rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row">
        ...
        <div className={`absolute top-0 left-0 w-full md:w-1/2 h-full flex flex-col justify-center px-8 md:px-12 py-8 transition-all duration-700 ease-in-out ${isLogin ? 'opacity-100 z-10 translate-x-0' : 'opacity-0 z-0 pointer-events-none -translate-x-8 md:-translate-x-12'}`}>
          <div className="flex flex-col items-center text-center w-full max-w-sm mx-auto">
            ...
            <div className="flex flex-col gap-4 w-full">
              <input type="email" placeholder="Email" className="w-full bg-white/60 border border-white/80 rounded-2xl px-5 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#5ac7ae] focus:bg-white transition-all shadow-sm placeholder:text-gray-400 font-medium" />
              <input type="password" placeholder="Password" className="w-full bg-white/60 border border-white/80 rounded-2xl px-5 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#5ac7ae] focus:bg-white transition-all shadow-sm placeholder:text-gray-400 font-medium" />
              
              <p className="text-xs text-gray-500 text-left cursor-pointer hover:text-[#2a9d82] hover:underline mt-1 font-medium">
                Forgot your password?
              </p>

              <button className="mt-4 w-full bg-gradient-to-r from-[#3bb397] to-[#2a9d82] hover:from-[#2a9d82] hover:to-[#1f826a] text-white font-bold rounded-2xl py-3.5 shadow-lg shadow-[#3bb397]/30 transition-all hover:scale-[1.02] active:scale-[0.98] tracking-wide">
                SIGN IN
              </button>

              {/* Mobile toggle */}
              <p className="md:hidden text-center text-sm text-gray-600 mt-4 font-medium">
                Don't have an account? <button onClick={(e) => { e.preventDefault(); setIsLogin(false); }} className="text-[#2a9d82] font-bold hover:underline">Sign Up</button>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`absolute top-0 right-0 w-full md:w-1/2 h-full flex flex-col justify-center px-8 md:px-12 py-8 transition-all duration-700 ease-in-out ${!isLogin ? 'opacity-100 z-10 translate-x-0' : 'opacity-0 z-0 pointer-events-none translate-x-8 md:translate-x-12'}`}>
          <div className="flex flex-col items-center text-center w-full max-w-sm mx-auto">
            ...
            <div className="flex flex-col gap-4 w-full">
              <input type="text" placeholder="Name" className="w-full bg-white/60 border border-white/80 rounded-2xl px-5 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#5ac7ae] focus:bg-white transition-all shadow-sm placeholder:text-gray-400 font-medium" />
              <input type="email" placeholder="Email" className="w-full bg-white/60 border border-white/80 rounded-2xl px-5 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#5ac7ae] focus:bg-white transition-all shadow-sm placeholder:text-gray-400 font-medium" />
              <input type="password" placeholder="Password" className="w-full bg-white/60 border border-white/80 rounded-2xl px-5 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#5ac7ae] focus:bg-white transition-all shadow-sm placeholder:text-gray-400 font-medium" />
              ...
              {/* Mobile toggle */}
              <p className="md:hidden text-center text-sm text-gray-600 mt-4 font-medium">
                Already have an account? <button onClick={(e) => { e.preventDefault(); setIsLogin(true); }} className="text-[#2a9d82] font-bold hover:underline">Sign In</button>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={`hidden md:block absolute top-0 left-0 w-1/2 h-full z-20 transition-transform duration-700 ease-in-out ${isLogin ? 'translate-x-full' : 'translate-x-0'}`}>
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-[#3bb397]/90 to-[#2a9d82]/90 backdrop-blur-xl flex flex-col items-center justify-center p-12 text-center text-white border-x border-white/20 shadow-[0_0_40px_rgba(59,179,151,0.4)] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              {/* Toggle Content depending on state */}
